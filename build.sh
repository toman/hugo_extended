...
#docker buildx build . --platform=linux/amd64 --build-arg NODE_VERSION=latest --build-arg HUGO_PLATFORM=linux-amd64 -t lillibolero/hugo_extended:1.14.0 -t lillibolero/hugo_extended:latest
